...
def process_session_calibrate(config, session_path):
    ...
    if not skip_calib:
        ...
        if calibration_error is None or calibration_error > 0.1:
            init_matrix = True
        ...
        calibration_error = cgroup.calibrate_rows(all_rows, board,
