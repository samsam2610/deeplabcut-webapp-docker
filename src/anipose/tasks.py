"""
Anipose + MediaPipe Celery tasks.
All task names preserve the original `tasks.XXX` namespace so that existing
Celery worker dispatches continue to work without change.
"""
